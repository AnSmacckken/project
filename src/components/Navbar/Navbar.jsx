...
export default function Navbar() {
  ...
  const userName = typeof window !== 'undefined' ? localStorage.getItem("userName") : null; // Retrieve the user's name from localStorage
  ...
  return (
    <nav className="navbar navbar-expand-md bg-main-light fixed-top border-bottom">
      <div className="container py-2">
        <NavLink className="navbar-brand mb-md-2 " href="/home">
